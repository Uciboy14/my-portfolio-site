...
const BlogCard = ({ image, date, comments, title, description, slug }) => {
  return (
    <div className="w-full md:w-1/2 lg:w-1/3 text-[#fafafa] font-light leading-[24px] px-[15px] text-left pb-8 md:mb-0">
      <div className="blog-content bg-gray-800 rounded-[20px] shadow-[0px_0px_2px_0px_#4f4f4f33] text-[#fafafa] w-[369px] h-[450px] font-light leading-[24px] p-[30px] text-left relative transition-all duration-300 hover:shadow-[0px_0px_20px_0px_#1ab39433] hover:-translate-y-1 flex flex-col">
        ...
        <div className="flex flex-col gap-4 mt-4 flex-grow">
          ...
          <p className="text-[#fafafa] font-light leading-6 text-left muli">
            {description}
          </p>
          <Link href={`/blog/${slug}`} className="text-[#1ab394] font-light leading-6 text-left muli flex items-center gap-2 hover:gap-3 transition-all duration-300 mt-auto">
